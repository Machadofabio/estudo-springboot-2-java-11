...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order o3 = new Order(null, Instant.parse("2019-08-22T15:21:22Z"), u3);
        Order o4 = new Order(null, Instant.parse("2019-09-20T19:53:07Z"), u4);
        Order o5 = new Order(null, Instant.parse("2019-10-21T03:42:10Z"), u5);
        Order o6 = new Order(null, Instant.parse("2019-11-22T15:21:22Z"), u6);
        Order o7 = new Order(null, Instant.parse("2019-12-20T19:53:07Z"), u1);
        Order o8 = new Order(null, Instant.parse("2020-01-21T03:42:10Z"), u1);
        Order o9 = new Order(null, Instant.parse("2020-02-22T15:21:22Z"), u2);
